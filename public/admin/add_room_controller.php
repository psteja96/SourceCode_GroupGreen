<?php
  ...
  $room_amenities=htmlspecialchars($room_amenities);
  $room_beds=htmlspecialchars($room_beds);
  $room_capacity=htmlspecialchars($room_capacity);
  $bed_type=htmlspecialchars($bed_type);
  $room_view=htmlspecialchars($room_view);
